...
## **Sleep EEG features, memory, and developmental outcomes**


#### *The role of 2 naps in infant memory consolidation* 

```{r itns, echo=FALSE,  out.width = '30%', out.extra='style="float:right; padding:10px"', fig.align = 'right'}
setwd("~/GitHub/MNHwebsite")
knitr::include_graphics("images/itns.jpg")

```

Triphasic sleep, with 2 daytime naps and one overnight sleep bout, is common in infancy. It is unclear what prompts the transition to only 1 nap per day though one hypothesis is that the shift is driven by neural maturation, specifically in regions relevant to memory consolidation (such as the hippocampus). In an R01 research study, we are examining infants' performance on a deferred imitation task following a morning and afternoon nap in a 2 week protocol. In one week, infants nap twice and in the other, they are kept awake during one nap period. They are tested longitudinally at 9, 12, and 15 months with polysomnography (sleep EEG) during each nap. Additionally, infants wear an actigraph to objectively measure typical sleep patterns over a 16-day window at each time period and caregivers complete a battery of surveys. 

#
#
# 

#### *The cessation of napping, hippocampal maturation, and memory performance* 

```{r hsr, echo=FALSE,  out.width = '30%', out.extra='style="float:right; padding:10px"', fig.align = 'right'}

knitr::include_graphics("images/hsr.png")

```

When unconstrained by external pressures (e.g., school requirements), children stop napping around preschool age (~3-5 years old). In a second R01 research project in the Somneuro Lab, we are directly investigating the role of hippocampal maturation in this process. Habitually napping children are enrolled in a year long longitudinal study with visits every 6 months in which we use polysomnography to study both napping and overnight sleep. Over the course of a 3 week protocol, children are taught a mnemonic similarities task in the afternoon and evening and tested after an afternoon nap, an afternoon awake, and in the morning after overnight sleep. About a week later, children undergo a structural and functional MRI. 

#

We recently authored a review paper with our collaborators at the University of Maryland on the relationship between changes in sleep architecture in early development and neural maturation. 

```{r, echo=FALSE}
downloadthis::download_link(
  link = "https://github.com/mhorger/MNHwebsite/raw/main/docs/articles/Riggins%20et%20al%20(2024)%20The%20importance%20of%20sleep%20for%20the%20developing%20brain.pdf",
...
In a study leveraging citizen science and computer vision technology, we studied how infants' reach-to-grasp strategies evolved 6 to 14-months. We use a customized software (TrHandy, Ab.Acus and HaMeR) to code videos submitted by parents and extract the kinematic properties of the reach and grasp. Of particular interest was the emergence of the mature pincer grasp. At 14-months, infants came to the lab and participated in a tactile oddball paradigm stimulating their fingertips while undergoing EEG. We focues on a neural signature (somatosensory mismatch negativity - sMMN) in the frontocentral regions to provide insight into the development of the somatosensory cortex. We hypothesized that functional differences in the way infants used their pinky and middle fingers to grasp would relate to neural body representations, manifesting as greater sMMN in response to a tactile stimulation of the middle finger versus the pinky finger. 


Download a copy of our presentation on the project at the International Congress on Infant Studies

```{r, echo=FALSE}

HTML('
<a href="https://github.com/mhorger/MNHwebsite/raw/main/articles/Early%20grasping%20trajectories%20and%20later%20neural%20representations%20of%20infant%20finger_ICIS.pdf" 
   target="_blank" 
   class="btn btn-warning" 
   role="button">
  <i class="fa fa-save"></i> Download PDF
</a>
')
...
downloadthis::download_link(
  link = "https://github.com/mhorger/MNHwebsite/raw/main/articles/Early%20grasping%20trajectories%20and%20later%20neural%20representations%20of%20infant%20finger_ICIS.pdf",
  button_label = "Download pdf file",
  button_type = "warning",
  has_icon = TRUE,
  icon = "fa fa-save",
...
A complimentary project with older participants also used the tactile oddball paradigm and sMMN.Here, we hypothesized that neural plasticity persists into adulthood and motor experience would change the neural representation of digits. Undergraduates participate in  a traditional measure of finger independence and completed questions about video game and music experience. We found that more experience using individual fingers and greater finger independence led to  greater sMMN in response to a tactile stimulation of the middle finger versus the pinky finger. 
...
```{r, echo=FALSE}
downloadthis::download_link(
  link = "https://github.com/mhorger/MNHwebsite/raw/main/docs/articles/Horger%2C%20Campbell%2C%20%26%20Marshall%20(2024)%20EEG%20response%20to%20digit%20stimulation.pdf",
  button_label = "Download pdf file",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
...
```{r, echo=FALSE}
downloadthis::download_link(
  link = "https://github.com/mhorger/MNHwebsite/raw/b022659d6690c61afa8397b694a193b4516b2e7e/articles/Berger,%20Harbourne,%20&%20Horger%202018.pdf",
  button_label = "Download pdf file",
  button_type = "primary",
  has_icon = TRUE,
  icon = "fa fa-save",
...
```{r, echo=FALSE}
downloadthis::download_link(
  link = "https://github.com/mhorger/MNHwebsite/raw/a4ead575b0eb2c2d613bff9630a140fde15c5e1f/articles/Berger,%20Horger,%20DeMasi,%20&%20Karasik%20(2021)%20Motor%20development%20in%20context.pdff",
  button_label = "Download pdf file",
  button_type = "info",
  has_icon = TRUE,
  icon = "fa fa-save",
...
downloadthis::download_link(
  link = "https://github.com/mhorger/MNHwebsite/raw/b022659d6690c61afa8397b694a193b4516b2e7e/articles/Horger%20&%20Berger%20(2019)%20The%20role%20of%20walking%20experience%20on%20whole%20body%20exploration%20and%20problem%20solving.pdf",
  button_label = "Download pdf file",
  button_type = "default",
  has_icon = TRUE,
  icon = "fa fa-save",
...
downloadthis::download_link(
  link = "https://github.com/mhorger/MNHwebsite/raw/f08d832d73d17e015f5c724b3fbac234826ebc47/articles/Horger%20et%20al%20(2021)%20Newly%20walking%20infants'%20night%20sleep%20impacts%20next%20day%20learning%20and%20problem%20solving.pdf",
  button_label = "Download pdf file",
  button_type = "danger",
  has_icon = TRUE,
  icon = "fa fa-save",
...
downloadthis::download_link(
  link = "https://github.com/mhorger/MNHwebsite/raw/b022659d6690c61afa8397b694a193b4516b2e7e/articles/DeMasi%20et%20al%20(2021)%20Nap%20timing%20makes%20a%20difference.pdf",
  button_label = "Download pdf file",
  button_type = "warning",
  has_icon = TRUE,
  icon = "fa fa-save",
...
The current study sought to tease apart the unique contributions of
napping and nighttime sleep to infant learning, specifically in the
context of motor problem solving. We challenged 54 walking
infants to solve a novel locomotor problem at three time points—
training, test, and follow-up the next morning. One group of infants
napped during the delay between training and test. Another group
did not sleep during the delay. A third group received the test
immediately after training with no delay. Only the Nap group’s
strategy choices continued to improve through the follow-up session,
suggesting that daytime sleep has an active role in strengthening
otherwise fragile memory. Although group did not affect
strategy maintenance, walk experience did, suggesting that task
difficulty may shape the impact of sleep on learning. Thus, day
sleep and night sleep make independent contributions to the consolidation
of motor problem-solving strategies during infancy.

```{r, echo=FALSE}

downloadthis::download_link(
  link = "https://github.com/mhorger/MNHwebsite/raw/main/articles/Horger%20et%20al%20(2023)%20The%20unique%20contributions%20of%20day%20and%20night%20sleep%20to%20infant%20motor%20problem%20solving.pdf",
  button_label = "Download pdf file",
  button_type = "success",
  has_icon = TRUE,
  icon = "fa fa-save",
...
Research studying the role of sleep in development abounds but focuses on global aspects of sleep
like quality or timing. Far fewer studies include the ultradian cycle, or patterns of REM and non-
REM (NREM), because doing so is costly in time and resources. In a complete, lab-based sleep
study, individuals are monitored by a technician overnight while wearing a host of sensors to
capture brain activity, eye and limb movement, and cardiorespiratory rates. There is a need for
creative, minimally disruptive solutions to study sleep that do not compromise the richness and
accuracy of the measurements. The current pilot study parsed down the physiological measures to
only movement and cardiorespiratory rates, creating a protocol simple enough for caregivers to
incorporate into bedtime. Ten 12-month-old infants (+/- 3 weeks) wore an actigraph and wireless
cardiorespiratory sensor for five nights of data collection. Of this, 92% were useable data.
Actigraphy was analyzed with the Sadeh algorithm to delineate sleep from wake. Heart rate and
respiration were then used to state score visually or via an algorithm; greater variability
demarcated REM from NREM. Time spent in each state was compared between scoring methods
as well as to published results from age matched infants who underwent polysomnography (PSG).
Visually scored data, using a 1-hour viewing window, was in line with peer’s PSG values. To
automatically state score, epoch-by-epoch cardiorespiratory and actigraphy files were produced
for each minute of data collection. Heart and respiratory rates were transformed into z-scores and
iterations of scoring, using increasingly greater z score thresholds, were compared to determine
which identified state proportions most similar to data collected with PSG. Based on these results,
our novel method appears to be a feasible choice for studying the ultradian cycle. The combination
of actigraphy and cardiorespiratory monitoring is uniquely advantageous because it is less
resource intensive and more naturalistic, being put on by caregivers while still resulting in high
rates of good data. Taken together, it is a quality option for infant researchers interested in
incorporating sleep into their paradigms.

```{r, echo=FALSE}

downloadthis::download_link(
  link = "https://github.com/mhorger/MNHwebsite/raw/main/articles/Horger%20(2022)%20Novel%20and%20noninvasive%20methods%20for%20in%20home%20sleep%20measurement.pdf",
  button_label = "Download pdf file",
  button_type = "info",
  has_icon = TRUE,
  icon = "fa fa-save",
